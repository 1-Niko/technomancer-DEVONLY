...
internal static class PlayerHooks
{
    ...
    private static void Player_Update(On.Player.orig_Update orig, Player self, bool eu)
    {
        ...
        switch (Utilities.Identify(scanline.arrow, scanline.thrw, scanline.jmp, scanline.inputHoldThrw, scanline.inputHoldJmp))
        {
            ...
            case 450:
                {
                    if (!Constants.TrackHologramMessage.TryGetValue(scanline.arrow._object, out var messenger)) Constants.TrackHologramMessage.Add(scanline.arrow._object, messenger = new TrackHologramMessenger());
